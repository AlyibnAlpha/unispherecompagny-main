...
<script>
import { LanguagesWithFlag } from '../../layouts/utils/topBar'
import HederLogo from '../../layouts/common/HeaderLogo.vue'
import AppSearch from '../common/AppSearch.vue'
import MobileAppSearch from '../common/MobileAppSearch.vue'
import LanguageDropdown from '../common/LanguageDropdown.vue'
import AppList from '../common/AppList.vue'
import Notifications from '../common/NotificationsLay.vue'
import Profile from '../common/ProfileLay.vue'
import MenuComponent from '../horizontal/MenuComponent.vue'
